...
随时掌握 LeekFund 扩展与 Pro 能力的变化：https://leek.fund/changelog

### 此文件版本号日志不再更新，维护到了官网，查看上边↑链接

### [非 VSCode 编辑器怎么安装最新版本？](https://github.com/LeekHub/leek-fund/issues/657)

--- 

## [4.0.5](https://leek.fund/)

- feat: 状态栏股票配置弹窗中 支持拖动股票调整顺序

## [4.0.4](https://leek.fund/)

- fix: 「免费版」Status Bar 切换不了票(Pro版本正常)
- fix: 兼容Cursor登陆问题 [#528](https://github.com/LeekHub/leek-fund/issues/639)
- fix: 支持国产IDE Trae 和 Qoder 登陆

## [4.0.3](https://leek.fund/)

- feat: 新增行情中继功能，功能路径：设置页>行情中继

在个人服务器或本机运行官方 Docker 镜像，将行情请求透明转发至证券API公网域名上游，解决公司网络拦截等问题。[详细文档](https://leek.fund/docs/market-data-relay)

## [4.0.2](https://leek.fund/)

- fix: 修复旧数据 leek-fund.stocks  升级4.0丢失
- feat: 设置页>数据项，增加【批量 code 导入】、【清理无效代码】两个功能

## [4.0.0](https://leek.fund/)

发布LeekFund Pro版本，新增以下功能：
