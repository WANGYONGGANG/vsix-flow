...
async function handler8(req, res) {
  ...
  try {
    ...
    const url2 = `https://push2.eastmoney.com/api/qt/clist/get?pn=1&pz=5000&po=1&np=1&ut=${ut}&fltt=2&invt=2&wbp2u=|0|0|0|web&fid=f3&fs=m:0+t:6,m:0+t:80,m:1+t:2,m:1+t:23,m:0+t:81+s:2048&fields=f2,f3`;
    const r3 = await httpGetJson(url2, "https://quote.eastmoney.com/center/gridlist.html");
    const diff = r3?.data?.diff || [];
    diff.forEach((row) => {
...
// lib/handlers/stock-fflow-day.ts
